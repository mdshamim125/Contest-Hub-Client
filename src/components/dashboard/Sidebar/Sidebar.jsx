        ...
        <nav className="flex-1 -mx-3 space-y-3">
          ...
          {endUser === "user" ? (
            <NavLink to="my-participated-contest" className={getNavLinkClass}>
              ...
              <span className="mx-2 text-white text-sm font-medium">
          ...
          {endUser === "creator" ? (
            <NavLink to="add-contest" className={getNavLinkClass}>
              ...
              <span className="mx-2 text-white text-sm font-medium">Add Contest</span>
            </NavLink>
          ) : (
            ""
          )}
          ...
          {endUser === "admin" ? (
            <NavLink to="manage-user" className={getNavLinkClass}>
              ...
              <span className="mx-2 text-white text-sm font-medium">Manage User</span>
            </NavLink>
          ) : (
            ""
          )}
          {endUser === "admin" ? (
            <NavLink to="manage-contests" className={getNavLinkClass}>
              ...
              <span className="mx-2 text-white text-sm font-medium">Manage Contests</span>
            </NavLink>
          ) : (
            ""
          )}
          ...
          {endUser === "user" ? (
            <div className="flex items-center justify-between mt-6">
              ...
              <NavLink
                ...
                onClick={logOut}
                href="#"
                className="text-white transition-colors duration-200 rotate-180  rtl:rotate-0 hover:text-blue-500 dark:hover:text-blue-400"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
